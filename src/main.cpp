...
int main(int argc, const char* argv[])
{
    ...
    program.add_argument("input_files")
        ...
        .required()
        .default_value(std::vector<std::string>{"hello.cyrex"});

    program.add_argument("--ir").help("output immediate representation").default_value(false).implicit_value(true);

    program.add_argument("--optimized").help("compile with optimization").default_value(false).implicit_value(true);
    ...
    for (const auto& filename : files)
    {
        ...
        LivenessAnalysis liveness(irgen);
        liveness.analyze();
