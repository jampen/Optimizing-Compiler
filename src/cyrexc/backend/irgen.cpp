...
{
    auto visitor = overloaded{[&](const AST::Top& x) { return top(x); },
...
CFGFunction& IRGen::get_function_by_name(const std::string& name)
{
    return mod.functions.at(name);
}
...
{
    auto visitor = overloaded{[&](const AST::Root& x) { return root(x); },
                              [&](const AST::Function& x) { return function(x); },
                              [&](const AST::ParameterList& x)
                              {
...
{
    auto visitor = overloaded{[&](const AST::IfStmt& x) { return if_stmt(x); },
...
ValueId IRGen::binary_expr(const AST::BinaryExpr& binary)
{
    ...
    switch (binary.kind)
    {
        case AST::BinaryExpr::Kind::Add:
            push_inst(Opcode::Add, res, {left, right});
            break;
        case AST::BinaryExpr::Kind::Sub:
            push_inst(Opcode::Sub, res, {left, right});
            break;
        case AST::BinaryExpr::Kind::CmpAnd:
            push_inst(Opcode::And, res, {left, right});
            break;
        case AST::BinaryExpr::Kind::CmpOr:
            push_inst(Opcode::Or, res, {left, right});
            break;
        case AST::BinaryExpr::Kind::CmpXor:
            push_inst(Opcode::Xor, res, {left, right});
            break;

        case AST::BinaryExpr::Kind::CmpLesser:
            push_inst(Opcode::Lesser, res, {left, right});
            break;
        case AST::BinaryExpr::Kind::CmpLesserOrEqual:
            push_inst(Opcode::LesserOrEqual, res, {left, right});
            break;
        case AST::BinaryExpr::Kind::CmpEqual:
            push_inst(Opcode::Equal, res, {left, right});
            break;
        case AST::BinaryExpr::Kind::CmpNotEqual:
            push_inst(Opcode::NotEqual, res, {left, right});
            break;
        case AST::BinaryExpr::Kind::CmpGreater:
            push_inst(Opcode::Greater, res, {left, right});
            break;
        case AST::BinaryExpr::Kind::CmpGreaterOrEqual:
            push_inst(Opcode::GreaterOrEqual, res, {left, right});
            break;
    }
    return res;
}
